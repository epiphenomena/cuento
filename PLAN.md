...
- [ ] **p23.12 ux: section-bar filters on the remaining pages.** Reconciliations, budgets, register still carry their filters in the page body; move them into the section bar with auto-apply — the date-range/account filters need the HX-Target partial-swap treatment (like accounts p23.10), a distinct follow-up from the New-button relocations of p23.11.
