...
// (p29.5 removed overallImbalance + its tests: the always-zero overall Total chip was
// dropped from the txn form, since the balancing main split makes the overall total 0.)
