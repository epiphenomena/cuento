...
func post(ctx context.Context, s *store.Store, date string, sub entids.SubsidiaryID, ccy, memo string, splits ...sp) (entids.TransactionID, error) {
...
func editTxn(ctx context.Context, s *store.Store, id entids.TransactionID, date string, sub entids.SubsidiaryID, ccy, memo string, splits ...sp) error {
